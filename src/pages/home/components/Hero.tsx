  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 w-full h-full">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-foreground-950/50 via-foreground-950/15 to-transparent"></div>
      </div>

      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-24">
        <div className={`max-w-xl ${revealClass(isVisible, 0)}`}>
          <h1
            className="text-5xl md:text-7xl lg:text-8xl text-background-50 leading-[1.08] tracking-tight mb-10"
          ...
          <a
            href="#contact"
            className="inline-block px-8 py-3 border border-background-50/70 text-background-50 text-xs tracking-[0.25em] uppercase hover:bg-background-50 hover:text-foreground-950 transition-all duration-500 whitespace-nowrap text-center cursor-pointer"
